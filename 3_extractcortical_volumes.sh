...
for subj_id in $(ls -d sub* | grep -v "^subcortical$"); do #may need to change this so that it selects subjects with FS output
...
cd ${enigmadir}/enigma_wrapscripts/Matlab

chmod 777 ${enigmadir}/enigma_wrapscripts/bash/make_cortical_FreeSurfer_external_QC_png_v2021.sh
source ${enigmadir}/enigma_wrapscripts/bash/make_cortical_FreeSurfer_external_QC_png_v2021.sh


chmod 777 ${enigmadir}/enigma_wrapscripts/bash/make_ENIGMA_QC_cortical_external_webpage_v2021.sh
${enigmadir}/enigma_wrapscripts/bash/make_ENIGMA_QC_cortical_external_webpage_v2021.sh ${enigmadir}/outputs/cortical/QC_cortical_external
